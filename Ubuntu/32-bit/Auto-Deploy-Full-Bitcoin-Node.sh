...
wget https://bitcoin.org/bin/bitcoin-core-0.10.0/bitcoin-0.10.0-linux32.tar.gz
echo "### Installing Bitcoin Core 0.10.0"
rm -f -r ~/Bitcoin-Core/
mkdir ~/Bitcoin-Core/
tar -xvvzf bitcoin-0.10.0-linux32.tar.gz --directory ~/Bitcoin-Core/ --strip-components 1
rm -f -r bitcoin-0.10.0-linux32.tar.gz
